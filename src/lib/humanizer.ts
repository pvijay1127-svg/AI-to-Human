...
*
* Provides text processing utilities for AI detection and humanization
*/
...
function estimateSyllables(text: string): number {
 ...
 return Math.max(syllables, cleanText.length / 3)
}
...
/**
* Creativity levels for humanization
*/
export const CREATIVITY_LEVELS = [
 { value: 'low', label: 'Conservative', description: 'Minimal changes, preserve original structure' },
 { value: 'medium', label: 'Balanced', description: 'Moderate changes for natural flow' },
 { value: 'high', label: 'Creative', description: 'Maximum creativity and variation' }
] as const