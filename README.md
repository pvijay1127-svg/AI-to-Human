...
│       └── dashboard/
│           └── page.tsx  # Dashboard page│       ├── components/   # UI components
...
This project uses Supabase for authentication. Users can:
- Sign up with email and password
- Sign in to access protected routes
- Access the dashboard after authentication

The authentication state is managed globally and persists across browser sessions.
