            ...
            <div className="glass p-8 rounded-3xl">
              ...
              <form className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="email"
                    className="w-full px-4 py-3 bg-white/50 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm"
